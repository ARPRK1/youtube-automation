...
// Style prompts tuned for "human effort" Shorts: documentary texture over
// glossy AI faces. Never ask for portraits of living people.
const STYLE_PROMPTS = {
  cinematic:
    'cinematic documentary still, natural film grain, subtle imperfections, dramatic but real lighting, objects and places only, empty of readable human faces, professional composition, no text, no watermark, no logo, no signature',
  photo:
    'photorealistic documentary photograph, natural lighting, slight film grain, editorial National Geographic style, real-world texture, objects places animals architecture only, no stock model face, no posed portrait, no text, no watermark, no logo',
  pencil:
    'detailed pencil sketch on textured paper, graphite drawing, fine cross-hatching, hand-drawn look, objects and landscapes only, black and white, professional illustrator quality, no portrait face, no text, no watermark, no logo, no signature',
  ink:
    'bold ink illustration, clean black line art with soft grey washes, graphic novel style for objects and places, high contrast, elegant, no readable face, no text, no watermark, no logo',
  charcoal:
    'expressive charcoal drawing of an object place or landscape, rich blacks and soft smudges, gallery sketch quality, monochrome, dramatic, no portrait, no text, no watermark, no logo',
  watercolor:
    'soft watercolor painting of a place object or nature scene, loose brush strokes, paper texture, muted elegant palette, artistic handmade look, no portrait face, no text, no watermark, no logo',
  map:
  ...
  whiteboard:
    'clean explainer diagram drawn on a white whiteboard with colored dry-erase markers, simple hand-drawn arrows and icons, minimalist, high contrast, no readable text or labels, no watermark, no logo, no human figures',
  diagram:
    'minimalist infographic-style vector diagram, flat design, simple geometric shapes and arrows illustrating a concept, clean modern color palette, no readable text or labels, no watermark, no logo, no human figures'
};
...
const ABSTRACT_FRAMING =
  'schematic illustration of the concept itself, objects shapes arrows and symbols only, empty of characters and faces, technical explainer aesthetic, handmade diagram feel';

// Even when a person is the subject, never render a face — symbols only.
// Random stranger faces are the #1 "AI slop" complaint on this channel.
const PERSON_SAFE_FRAMING =
  'symbolic scene only: empty chair desk coat map medal monument or silhouette from far behind, face completely hidden or absent, no portrait, no identifiable person';
