 ...
 * durationSec, hadPause }. `srtPath` is null for Kokoro and Chatterbox (no
 * native word timing -- lib/captions.js falls back to even distribution
 * across the known real duration in that case).
 */
