...
// is free visual polish, not a new dependency. Kept to a subset that's
// been stable across ffmpeg's xfade implementation rather than the full
// list (some of the newer/exotic ones render inconsistently across
// versions).
const FADE_TRANSITION_TYPES = ['fade', 'wipeleft', 'wiperight', 'slideup', 'slidedown', 'smoothleft', 'smoothright', 'circleopen', 'dissolve', 'radial'];
