...
/**
 * Renders one segment of the background: tries a real, contextually
 * relevant video/photo (see visual-sources.js) for `query`, falling back to
 * `fallbackQuery` if nothing was found, and finally to a generated gradient
 * so a segment can never fail outright. Returns a credit string or null.
 */
