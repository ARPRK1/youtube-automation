...
const METADATA_SHAPE = `{
  ...
  "chapters": [{"title": "a concrete, visual 3-6 word phrase describing what this section of the video is actually about, specific enough to use as an image/video search query (e.g. 'Mumbai stock exchange trading floor', NOT a generic label like 'Hook' or 'Introduction')"}, {"title": "..."}, ... 5-8 chapters covering the whole script in order]
}`;
